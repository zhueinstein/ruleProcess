 ...
 */
public class RuleTest_ChinesePatentMedicineToxicity {

	/**
	 * 中成药毒副作用累加(脑安胶囊 with 复方丹参滴丸)
	 */
		@Test
		public void ChinesePatentMedicineToxicity_01(){
			...
			drugInfoRuleModel2.setCommonName("复方丹参滴丸");
			...
			kieSession.fireAllRules(new AgendaFilter() {
				...
				public boolean accept(Match match) {
					return match.getRule().getName().startsWith("ChinesePatentMedicineToxicity");
				}
			});
			kieSession.dispose();
	...
	/**
	 * 中成药毒副作用累加(脑安胶囊 with 复方丹参片)
	 */
	@Test
	public void ChinesePatentMedicineToxicity_02(){
		OrderInfoRuleModel orderInfoRuleModel = new OrderInfoRuleModel();
		PatientInfoRuleModel patientInfoRuleModel = new PatientInfoRuleModel();
		patientInfoRuleModel.setAge(65);
		patientInfoRuleModel.setPatientId("abc123");
